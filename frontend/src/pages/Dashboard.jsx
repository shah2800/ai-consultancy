    ...
    <div className="page-shell" style={{ maxWidth: 1100 }}>
      ...
      <section className="dashboard-section" aria-labelledby="dash-intel-heading">
        ...
        <div className="dashboard-kpi-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(156px, 1fr))" }}>
          ...
          <MetricCard
            label="Pending Docs"
            value={data.pendingDocumentAlerts || 0}
            sub="awaiting document officer review"
            accent={Number(data.pendingDocumentAlerts || 0) > 0 ? "var(--warm)" : "var(--success)"}
            onClick={() => navigate("/website-applications")}
          />
          <MetricCard
